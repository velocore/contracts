...
contract Minter is IMinter {
    uint256 internal constant WEEK = VELOCORE_EPOCH_DURATION; //86400 * 7; // allows minting once per week (reset every Thursday 00:00 UTC)
    ...
    uint256 public weekly = 1_400_000 * 1e18; // represents a starting weekly emission of 15M FLOW (FLOW has 18 decimals)
